...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing Deshi Love'
    else
        figlet Deshi Bomb
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mDeshi Lover \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Deshi Lover
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Telegram: https://t.me/DeshiLoveChat \e[0m"
    echo -e "\e[4;32m   YouTube: https://youtu.be/C2Ho-uWCw6Q \e[0m"
    echo " "
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Deshi Lover > .update
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN DeshiBomb Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
